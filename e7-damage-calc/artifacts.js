...
const artifacts = {
 ...
 diguanchangqiang: {
  ...
  daydream_joker: {
    ...
    flat: (artiScale) => elements.target_max_hp.value() * Number(document.getElementById("pdc").value)*0.01*artiScale
  },
  dignus_orb: {
    id: 'dignus_orb',
    name: 'Dignus Orb',
  ...
  pray: {
    ...
    scale:[0.05, 0.055, 0.06, 0.065, 0.07, 0.075, 0.08, 0.085, 0.09, 0.095, 0.1],
    type: artifactDmgType.damage,
    form: [elements.caster_add],
    value: (artiScale) => artiScale*(elements.caster_add.value() ? 2 : 1),
    exclusive: classType.warrior,
  },
  sword_of_adin: {
    id: 'sword_of_adin',
