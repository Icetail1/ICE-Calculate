...
const heroes = {
  ...
  hwayoung: {
	...
	soulburn: true,
        ...
        pow: 1,
        afterMath: (hitType,soulburn) => soulburn ?  ({ atkPercent: 0.7, penetrate: 0.7}) : ({ atkPercent: 0.35, penetrate: 0.7}),
        enhance: [0.05, 0, 0.1, 0, 0.15],
        single: true,
        noCrit: true,
      },
  ...
  ravi: {
    ...
    hpTransAtk: () => elements.caster_max_hp.value()*0.08,
    skills: {
      s1: {
        soulburn: true,
        rate: (soulburn) => soulburn ? 2.5 : 1,
  ...
  silver_blade_aramintha: {
    ...
    dot: [dot.burn,elements.caster_max_hp],
    skills: {
      s1: {
        rate: 1,
        pow: 1,
  ...
  vildred: {
    ...
    skills: {
      ...
      s3: {
        ...
        rate: (soulburn) => soulburn ? 1.1 : 0.85,
        pow: 1,
        mult: (soulburn) => 1 + elements.caster_speed.value()*(soulburn ? 0.001125 : 0.001125),
        multTip: (soulburn) => ({ caster_speed: soulburn ? 0.1125 : 0.1125 }),
        exEq: () => elements.exclusive_equipment_2.value() ? 0.1 : 0,
        enhance: [0.05, 0.05, 0, 0.1, 0.1],
        aoe: true,
      }
  ...
  winter: {
    ...
    skills: {
      ...
      s3: {
        rate: 0.8,
        pow: 0.95,
        fixed: (hitType) => (hitType == hitTypes.crit) ?5000*(elements.s3_stack.value()+1) : 0,
        enhance: [0.05, 0.05, 0, 0.05, 0.05, 0.1, 0.1],
        single: true,
      },
    }
  ...
  karina: {
    ...
    skills: {
      ...
      s3: {
        ...
        afterMathNoAdd: (hitType,soulburn) => (hitType !== hitTypes.miss) ? { defPercent: 1.4, penetrate: 0.7 } : null,
        enhance: [0.05, 0.05, 0, 0.1, 0.1],
        single: true,
      }
    }
  ...
  last_piece_karin: {
    ...
    skills: {
      s1: {
        ...
        pow: 1,
        enhance: [0.05, 0, 0.05, 0, 0.1, 0,0.1],
        flat: () => elements.caster_neo_phantom_sword.value() ? elements.target_max_hp.value()*0.3 : 0 ,
        flatTip: () => ({ target_max_hp: 30 }),
        mult: () => 1 + elements.caster_speed.value()*(0.00075),
        multTip: () => ({ caster_speed:0.075 }),
        single: true,
      },
...
　jenua: {
    ...
    skills: {
      ...
      s3: {
        ...
        pow: 0.95,
	penetrate: () => 1.0,
        afterMathNoAdd: (hitType,soulburn) => (hitType !== hitTypes.miss) ? { atkPercent: 0.6, penetrate: 0.7 } : null,
        enhance: [0.05, 0.05, 0.05, 0.05, 0.05,0.1],
        single: true,
      }
    }
